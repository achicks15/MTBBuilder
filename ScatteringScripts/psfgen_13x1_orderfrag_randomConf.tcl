...
proc loop_PF_CC1NT { pfmax pref chid attype count_varname} {
upvar 1 $count_varname count
...
set randomize_conformerlist [randomize_conformers $conformerlist 13];
...
variable rand_conf_count 0;
foreach pch $btublist {
     loop_PF_CC1NT 13 "PRO" $pch "C1" "rand_conf_count"
     set rand_conf_count ;
     puts $rand_conf_count 
}
...
guesscoord 
writepsf $outdir/3jalfull_13x1_gmoltype_RandConf.psf
writepdb $outdir/3jalfull_13x1_gmoltype_RandConf.pdb 

psfgen_logfile close 

## uncomment if need gromacs topology
...
#mol new $outdir/3jalfull_13x1_gmoltype_RandConf.psf
#mol addfile $outdir/3jalfull_13x1_gmoltype_RandConf.pdb

#topo writegmxtop $outdir/topol_3jal_13x1_gmoltype_RandConf.top $topolist
